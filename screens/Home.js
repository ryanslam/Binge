...
const Users = [
  {id: "1", uri: require('../assets/foods/1.jpg')},
  {id: "2", uri: require('../assets/foods/2.jpg')},
  {id: "3", uri: require('../assets/foods/3.jpg')},
  {id: "4", uri: require('../assets/foods/4.jpg')},
  {id: "5", uri: require('../assets/foods/5.jpg')},
]
          ...
          <Animated.View 
            ...
            style={[this.rotateAndTranslate,
              ...
              <View style={{flex:1, height:null, width:null, resizeMode: 'cover',
                ...
                <Image style={{flex:1, height:null, width:null, resizeMode: 'cover', borderTopLeftRadius:20, borderTopRightRadius:20 }} 
                source={item.uri} />
      ...
      <View style={{flex:1}}>
        ...
        <View style={styles.container}>
          <Text style={styles.paragraph}>
            There are no more recipes at the moment
          </Text>
          {this.renderUsers()}      
        </View>
        <View style={{height:60}}>
